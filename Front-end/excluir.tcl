...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 300x200+660+210
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab46 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Selecione o Id para excluir} 
    ...
    ###################
    place $top.lab46 \
        -in $top -x 0 -relx 0.267 -y 0 -rely 0.15 -width 0 -relwidth 0.48 \
        -height 0 -relheight 0.105 -anchor nw -bordermode ignore 
    place $top.ent47 \
        -in $top -x 0 -relx 0.233 -y 0 -rely 0.3 -width 164 -relwidth 0 \
        -height 40 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 0 -relx 0.133 -y 0 -rely 0.65 -width 97 -relwidth 0 \
        -height 44 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 0 -relx 0.533 -y 0 -rely 0.65 -width 97 -relwidth 0 \
        -height 44 -relheight 0 -anchor nw -bordermode ignore 
