...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 655x585+660+210
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    entry $top.ent54 \
        -background white -disabledforeground #a3a3a3 -font TkFixedFont \
        -foreground $vTcl(actual_gui_fg) -insertbackground black -width 174 
    vTcl:DefineAlias "$top.ent54" "Entry3" vTcl:WidgetProc "Toplevel1" 1
    button $top.but55 \
    ...
    ###################
    place $top.lab46 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.112 -width 0 -relwidth 0.09 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.lab47 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.178 -width 0 -relwidth 0.057 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.244 -width 0 -relwidth 0.09 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.lab49 \
        -in $top -x 0 -relx 0.183 -y 0 -rely 0.311 -width 0 -relwidth 0.057 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.ent50 \
        -in $top -x 0 -relx 0.301 -y 0 -rely 0.112 -width 174 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent51 \
        -in $top -x 0 -relx 0.3 -y 0 -rely 0.178 -width 174 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent52 \
        -in $top -x 0 -relx 0.3 -y 0 -rely 0.244 -width 174 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent54 \
        -in $top -x 0 -relx 0.3 -y 0 -rely 0.311 -width 174 -relwidth 0 \
        -height 20 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but55 \
        -in $top -x 0 -relx 0.314 -y 0 -rely 0.389 -width 47 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but56 \
        -in $top -x 0 -relx 0.452 -y 0 -rely 0.389 -width 67 -relwidth 0 \
        -height 24 -relheight 0 -anchor nw -bordermode ignore 
